...
export default class reel_element extends cc.Component {
    ...
    create_element_select(result_obj:result_obj, add_parent:cc.Node){
        if(this.cb_custom_element_by_id){
            return this.cb_custom_element_by_id(result_obj, add_parent);
        }else{
            return this.create_element_by_id(result_obj, add_parent);
        }
    }
    ...
    create_element_by_id(result_obj:result_obj, add_parent:cc.Node, only_create?:boolean){
        ...
        if(only_create){
            ...
            c_element_node.name = element_node.name;
        ...
        if(element_node == null){
            cc.error('cc.find(element_+id, this.template_element) id:' + id);
        ...
        c_element_node.parent = add_parent;
        return c_element_node;
    }
